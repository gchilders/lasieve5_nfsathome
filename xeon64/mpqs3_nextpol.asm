...
function_head(asm3_next_pol11_xmm)
	...
	movq $mpqs3_FB_disp,disp_ptr
	movq $mpqs3_FB_np_px,p_ptr
	movq $mpqs3_FB_mm_inv,inv_ptr
	movq $mpqs3_FB_start,start_ptr
np11_mainloop:
	movaps (p_ptr),%xmm0     # p
...
function_head(asm3_next_pol3plus)
	movq $mpqs3_FB_start,%rcx
	movq $mpqs3_FB_np_p,%rdx
	movq $0x00010001,%rax
	movd %rax,%mm7
	psllq $32,%mm7
	movd %rax,%mm6
